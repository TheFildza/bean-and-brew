  ...
  return (
    <form action={action} className="space-y-5 max-w-2xl">
      <div className="grid grid-cols-2 gap-5">
        ...
        <div>
          <label className="block text-sm font-medium text-[#1A120B] mb-1">Origin *</label>
      ...
      <div className="grid grid-cols-3 gap-5">
        <div>
          <label className="block text-sm font-medium text-[#1A120B] mb-1">Roast Level *</label>
        ...
        <div>
          <label className="block text-sm font-medium text-[#1A120B] mb-1">Price ($) *</label>
          <input name="price" type="number" step="0.01" min="0" required defaultValue={d.price} className="input" />
        </div>
        <div>
          <label className="block text-sm font-medium text-[#1A120B] mb-1">Stock Qty *</label>
          <input name="stock_quantity" type="number" min="0" required defaultValue={d.stock_quantity ?? 0} className="input" />
        </div>
      </div>

      <div>
        <label className="block text-sm font-medium text-[#1A120B] mb-1">Flavor Notes</label>
      ...
      <div>
        <label className="block text-sm font-medium text-[#1A120B] mb-1">Description</label>
        <textarea name="description" rows={3} defaultValue={d.description} className="input resize-none" />
      </div>

      <div>
        <label className="block text-sm font-medium text-[#1A120B] mb-1">Image URL</label>
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className="w-4 h-4 accent-[#1A120B]"
        />
        <label htmlFor="is_active" className="text-sm font-medium text-[#1A120B]">
          Active (visible in catalog)
        </label>
      </div>

      <div className="flex gap-3 pt-2">
        <button type="submit" className="bg-[#1A120B] text-[#FAF8F6] px-6 py-2 rounded hover:bg-[#3C2A21] transition-colors font-medium">
          {submitLabel}
        </button>
