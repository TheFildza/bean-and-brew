  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="font-serif text-2xl font-bold text-[#2C1810]">My Account</h1>
      ...
      <h2 className="font-serif text-xl font-bold text-[#2C1810] mb-4">Order History</h2>

      {orders.length === 0 ? (
        <div className="text-center py-12 text-[#3C2A21]">
          <p className="mb-4">No orders yet.</p>
          <a href="/" className="bg-[#2C1810] text-[#FDF8F3] px-6 py-2 rounded hover:bg-[#3C2A21] transition-colors text-sm font-medium">
            Shop Now
          </a>
        </div>
      ) : (
        <div className="space-y-4">
          {orders.map(order => (
            <div key={order.id} className="bg-white/80 backdrop-blur-sm rounded-xl shadow-sm p-5">
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="text-right">
                  ...
                  <p className="font-serif font-bold text-[#2C1810] mt-1">${Number(order.total_amount).toFixed(2)}</p>
                </div>
              </div>
