  ...
  return (
    <div className="min-h-screen bg-[#FAF8F6] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <h1 className="font-serif text-3xl font-bold text-[#1A120B] text-center mb-2">Welcome back</h1>
        ...
        <p className="text-center text-sm text-[#3C2A21] mt-6">
          No account?{' '}
          <a href="/register" className="text-[#1A120B] font-medium hover:underline">Register</a>
        </p>
      </div>
    </div>
  )
